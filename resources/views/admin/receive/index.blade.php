...
@section('content')
    <div class="appHeader bg-gradient-primary text-light border-0 d-flex align-items-center px-3" style="height: 60px; background: linear-gradient(135deg, #007bff, #0056b3);">
        ...
        <div class="pageTitle flex-grow-1 text-center">
            <span class="fw-bold" style="font-size: 20px; letter-spacing: 0.5px;">Manage Received Payments</span>
        </div>
        <div class="right d-flex align-items-center gap-2">
            <a href="{{ route('receive.create') }}" class="headerButton d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; background: rgba(255,255,255,0.2); border-radius: 50%; transition: background 0.3s ease;" title="Receive Payment">
            ...
            @if ($payments->isEmpty())
                <div class="card border-0 shadow-sm rounded-4 text-center">
                    <div class="card-body py-5">
                        ...
                        <p class="text-muted mb-0 small">Start by receiving a payment.</p>
                    </div>
                </div>
            @else
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td class="py-3 pe-3 text-end">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="{{ route('receive.edit', $payment['id']) }}" class="btn btn-sm btn-outline-warning rounded-pill px-2 py-1" style="font-size: 0.75rem;">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content border-0 rounded-4 shadow-sm">
                                                        ...
                                                        <div class="modal-footer border-0 justify-content-center">
                                                            ...
                                                            <form action="{{ route('receive.destroy', $payment['id']) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you absolutely sure?');">
                                                                @csrf
                                                                @method('DELETE')
