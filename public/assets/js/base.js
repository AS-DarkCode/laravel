...
if (gr.includes("bragherstudio.com")) {
  var _0x2268cb = {
    "enable": true
  };
  var _0x271bf4 = {
  ...
  if (_0x32e869.PWA.enable && "serviceWorker" in navigator) {
  ...
  function themeTesting() {
    var _0x4560d8 = function () {
      var _0x32380f = true;
      return function (_0x1825f4, _0x420414) {
        var _0x39c737 = _0x32380f ? function () {
          if (_0x420414) {
            var _0x5642d3 = _0x420414.apply(_0x1825f4, arguments);
            _0x420414 = null;
            return _0x5642d3;
          }
        } : function () {};
    ...
    var _0x9d7187 = _0x4560d8(this, function () {
      return _0x9d7187.toString().search("(((.+)+)+)+$").toString().constructor(_0x9d7187).search("(((.+)+)+)+$");
    });
    _0x9d7187();
    ...
    window.addEventListener("keypress", function (_0x175e9d) {
      ...
      if (_0x386899 == _0x10dee3 || _0x386899 === _0x10dee3) {
        ...
        if (_0x32e869.Test.alert) {
          ...
          var _0x2e5e72 = "<div id='alert-toast' class='toast-box toast-center tap-to-close'><div class='in'><div class='text'><h1 class='text-light mb-05'>🤖</h1><strong>" + _0x32e869.Test.alertMessage + "</strong></div></div></div>";
